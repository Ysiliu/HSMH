...
from component.port import PortHost,Port,Port_siml_EDF
from component.switch import Switch
from component.fifoqueue import FifoQueue
from component.heapqueue import EDFHeapQueue
...
port3=Port_siml_EDF('switch1_port3',2001,1004,gcl,link4)
port3.queues=[EDFHeapQueue(1000),FifoQueue(1000),FifoQueue(1000),FifoQueue(1000)]
